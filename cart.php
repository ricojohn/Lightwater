    ...
    <div class="container">
        ...
        <div class="card rounded-0">
            <div class="card-body">
                ...
                <?php 
                    $qry = $conn->query ("SELECT cart.*, products.title, products.id as pid FROM `cart` INNER JOIN `products` ON cart.stat_id = products.id WHERE `client_id` = " . $_settings->userdata('id'));
