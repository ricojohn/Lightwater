...
if(isset($_GET['id']) && $_GET['id'] > 0){
    ...
    $query = "SELECT * FROM stat WHERE product_id = '".$_GET['id']."'";
...
<div class="card card-outline card-info">
	...
	<div class="card-body">
		<form action="" id="product-form">
			<input type="hidden" id="product_id" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
			...
			<div class="form-group">
				<label for="title" class="control-label">Jar Name</label>
                <textarea name="title" id="" cols="30" rows="2" class="form-control form no-resize"><?php echo isset($title) ? $title : ''; ?></textarea>
			</div>
            <div class="form-group">
				<label for="price" class="control-label">Price</label>
                <textarea id="price" cols="30" rows="2" class="form-control form no-resize" name="price"><?php if(isset($_GET['id'])){echo $row1['price']; }else{} ;?></textarea>
			</div>
            <div class="form-group">
...
<script>
	...
	$(document).ready(function(){
		...
		$('#product-form').submit(function(e){
            var price_product123 = $('#price').val();
            ...
            $.ajax({
                ...
                method:"POST",
                data:{id:id,price_product123:price_product123},
