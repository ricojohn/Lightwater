<!-- Navbar -->
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
    <a href="http://localhost/Lightwater/admin" class="brand-link bg-primary text-sm">
      <img src="http://localhost/Lightwater/uploads/received_347587078009688.jpeg" alt="Store Logo" class="brand-image img-circle elevation-3" style="opacity: .8;width: 2.5rem;height: 2.5rem;max-height: unset">
