...
if(isset($_GET['id']) && $_GET['id'] > 0){
    $qry = $conn->query("SELECT * from `stat` where id = '{$_GET['id']}' ");
    if($qry->num_rows > 0){
...
<div class="card card-outline card-info">
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="stat-form">Save</button>
		<a class="btn btn-flat btn-default" href="?page=stat">Cancel</a>
	</div>
</div>
<script>
	...
	$(document).ready(function(){
		...
		$('#stat-form').submit(function(e){
			...
			start_loader();
			$.ajax({
				url:_base_url_+"classes/Master.php?f=save_stat",
